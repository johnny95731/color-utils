...
<details>
<summary><code>rgb2lLuminance(rgb: readonly number[] | string): number</code></summary>
...
```js
rgb2lLuminance([191, 123, 86]);   // 0.259141693330052
rgb2lLuminance([0, 0, 0]);        // 0
rgb2lLuminance([255, 255, 255]);  // 1
```
...
`getRelativeLuminance` is deprecated. An alias of `rgb2lLuminance`.
